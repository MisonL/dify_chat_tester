...
class DifyChatTesterError(Exception):
    """基础异常类 - 所有项目异常的父类"""
...
class ProviderError(DifyChatTesterError):
    """AI 供应商相关错误"""

    pass


class ConfigError(DifyChatTesterError):
    """配置相关错误"""

    pass


class BatchProcessError(DifyChatTesterError):
    """批量处理相关错误"""

    pass


class QuestionGenerationError(DifyChatTesterError):
    """问题生成相关错误"""

    pass


class NetworkError(DifyChatTesterError):
    """网络相关错误"""
