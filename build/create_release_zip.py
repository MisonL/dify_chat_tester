"""
============================================================================
Dify Chat Tester Windows 发布包创建脚本
============================================================================

功能：
  1. 将 PyInstaller 打包的可执行文件复制到发布目录
  2. 复制配置模板、文档、示例插件
  3. 生成带版本号和时间戳的 ZIP 压缩包

调用方式：
  由 build_windows.bat 自动调用，或手动运行：
    py build/create_release_zip.py

输出：
  - release_windows/                      发布目录
  - dify_chat_tester_windows_v*.zip       发布压缩包
============================================================================
"""
