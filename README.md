...
我们为您准备了详细的[**用户使用指南**](用户使用指南.md)，包含：

| 📋 内容 | 📝 说明 |
|--------|---------|
| 🔧 **环境准备** | VSCode、Python、Git for Windows 安装 |
| 📦 **项目部署** | 克隆项目、安装 uv、配置依赖 |
| ⚙️ **软件配置** | VSCode 中文界面、Git Bash 终端设置 |
| 🚀 **使用教程** | 会话模式、批量模式详细说明 |
| ❓ **常见问题** | 安装和使用过程中的问题解答 |

**👉 [点击查看完整用户使用指南](用户使用指南.md)**

适合所有水平的用户，特别是初学者，按照步骤即可轻松上手！
